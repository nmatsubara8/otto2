...
def run(cfg):
   #cwd = os.path.dirname(Path(hydra.utils.get_original_cwd()))
    ...
    data = [pd.read_pickle('/mnt/c/Users/admin/OneDrive/ドキュメント/GitHub/otto2' + f"/features/{f}.pkl") for f in cfg.features]
    ...
    #mlflow.set_tracking_uri("file://mnt/c/Users/admin/OneDrive/ドキュメント/GitHub/otto2/src/mlruns")
